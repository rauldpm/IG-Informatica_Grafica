...
Octaedro::Octaedro(){
  ...
  Figura::caras.push_back(0);  Figura::caras.push_back(4);  Figura::caras.push_back(1);
  Figura::caras.push_back(0);  Figura::caras.push_back(2);  Figura::caras.push_back(4);
  Figura::caras.push_back(1);  Figura::caras.push_back(5);  Figura::caras.push_back(3);
  Figura::caras.push_back(3);  Figura::caras.push_back(5);  Figura::caras.push_back(2);
  Figura::caras.push_back(2);  Figura::caras.push_back(5);  Figura::caras.push_back(4);
  Figura::caras.push_back(4);  Figura::caras.push_back(5);  Figura::caras.push_back(1);
